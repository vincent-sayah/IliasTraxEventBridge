...
check_marker "outbox technical config" "Configuration technique outbox" "$ACTIVE_SCREEN"
...
check_marker "outbox technical config" "Configuration technique outbox" "$TEMPLATE_SCREEN"
