...
PATCHER="$PLUGIN_ROOT/scripts/patch_course_ui_delos_navigation.php"
...
if [[ ! -f "$PATCHER" ]]; then
  echo "Delos navigation patcher not found: $PATCHER" >&2
  exit 1
fi
...
echo "Delos Suivi xAPI navigation fix completed."
